...
def parse_arguments(parser):
    ...
    parser.add_argument("-rho_start", "--rho_start", default=None, type=str, help="Starting electron density map filename (for use in denss.refine.py only)")
    parser.add_argument("-rho_known", "--rho_known", default=None, type=str, help="Known part of the structure for reference, must be aligned to rho_start, or else the COM of the molecule (for use in denss.refineAB_A.py-type scripts only).")
